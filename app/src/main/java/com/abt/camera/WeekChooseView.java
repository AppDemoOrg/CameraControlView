 ...
 * @创建时间： @2018-02-06
 */
public class WeekChooseView extends View {
    ...
    public WeekChooseView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WeekChooseView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(widthMode == MeasureSpec.EXACTLY ? widthSize : widthSize, heightMode == MeasureSpec.EXACTLY ? heightSize : dp2px(getContext(), 100));
    }
